...
// Connect to MongoDB
mongoose.connect(
  "mongodb+srv://Vicky:Vikas18@p2auction.dppyrrg.mongodb.net/",
  {
...
app.post("/auction", authenticate, async (req, res) => {
  try {
    const { itemName, description, startingBid, highestBidder, closingTime } = req.body;

    if (!itemName || !description || !startingBid || !highestBidder || !closingTime) {
